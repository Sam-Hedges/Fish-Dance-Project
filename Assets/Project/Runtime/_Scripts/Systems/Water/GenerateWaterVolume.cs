...
public class GenerateWaterVolume : MonoBehaviour
{
    // Generate a unity class that generates a 3D subdivided box mesh
    // The mesh is subdivided in the X and Z directions
    ...
    /// <summary>
    /// Used to determine the maximum size of the mesh
    /// </summary>
